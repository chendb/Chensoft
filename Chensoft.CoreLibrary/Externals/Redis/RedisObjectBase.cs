...
{
	public abstract class RedisObjectBase : MarshalByRefObject, Chensoft.Common.IDisposableObject
	{
		#region 事件定义
		...
		private Chensoft.Collections.ObjectPool<ServiceStack.Redis.IRedisClient> _redisPool;
		#endregion

		#region 构造函数
		protected RedisObjectBase(string name, Chensoft.Collections.ObjectPool<ServiceStack.Redis.IRedisClient> redisPool)
		{
		...
		#region 保护属性
		protected Chensoft.Collections.ObjectPool<ServiceStack.Redis.IRedisClient> RedisPool
		{
			get
			{
				return _redisPool;
