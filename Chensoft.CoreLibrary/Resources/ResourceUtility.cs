...
namespace Chensoft.Resources
{
	...
	public static class ResourceUtility
	{
		...
		/// <remarks>
		///		<para>
		///		譬如<paramref name="baseName"/>参数为：Chensoft.EAS.Web，则返回的数组元素分别为：
		///		<list type="number">
		///			<item>
		///				<term>Chensoft.EAS.Web</term>
		///			</item>
		///			<item>
		///				<term>Chensoft.EAS.Web.Resources</term>
		///			</item>
		///			<item>
		///				<term>Chensoft.EAS.Web.Properties.Resources</term>
		///			</item>
		///			<item>
		///				<term>Chensoft.EAS</term>
		///			</item>
		///			<item>
		///				<term>Chensoft.EAS.Resources</term>
		///			</item>
		///			<item>
		///				<term>Chensoft.EAS.Properties.Resources</term>
		///			</item>
		///			<item>
		///				<term>Chensoft</term>
		///			</item>
		///			<item>
		///				<term>Chensoft.Resources</term>
		///			</item>
		///			<item>
		///				<term>Chensoft.Properties.Resources</term>
		///			</item>
		///		</list>
		///		</para>
		/// </remarks>
		...
		/// <remarks>
		///		<para>
		///		如果<paramref name="assembly"/>参数为空(null)，该方法执行效果与<see cref="GetBaseNames(string)"/>方法功能一样。
		///		</para>
		///		<para>
